...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  void PlotAll_CFD_DeltaTs_SIM(unsigned int channelNumber, double SignalAmpLow, double SignalAmpHigh, std::string prefix);
...
void pulse::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("t0CFD_90", t0CFD_90, &b_t0CFD_90);
   fChain->SetBranchAddress("t1CFD_90", t1CFD_90, &b_t1CFD_90);
   fChain->SetBranchAddress("totCFD_90", totCFD_90, &b_totCFD_90);
